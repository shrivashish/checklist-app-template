...
export class InputBox extends React.Component<IInputBoxProps> {
    ...
    componentDidMount() {
        if (this.renderAs == RenderAs.TextArea && (!ActionSDKUtils.isEmptyObject(this.props.value) || !ActionSDKUtils.isEmptyObject(this.props.defaultValue))) {
    ...
    render() {
        ...
        return (
            <Flex column>
                {(this.props.showError && !ActionSDKUtils.isEmptyObject(this.props.errorText))
    ...
    private updateInputBox() {
        if (this.renderAs == RenderAs.TextArea) {
            ...
            var text: string = "";
            if (!ActionSDKUtils.isEmptyObject(this.props.value)) {
                text = this.props.value.toString();
            } else if (!ActionSDKUtils.isEmptyObject(this.props.defaultValue)) {
