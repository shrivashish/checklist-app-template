...
import { Popup, Input, List, ListProps, FocusTrapZone } from '@fluentui/react-northstar';

import './TimePickerView.scss';
//import { FocusTrapZone } from '@fluentui/react-northstar/dist/es/lib/accessibility/FocusZone';
